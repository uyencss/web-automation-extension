...
**Files:**
- Modify: `mcp-web-extension/skills/webmcp-browser-automation/SKILL.md` (the "First Choice Transport" section — add a "Targeting a profile" subsection after the *Request shape* block; and the "Mandatory Run Loop" step 1)
...
In `mcp-web-extension/skills/webmcp-browser-automation/SKILL.md`, find the *Request shape* block in the "First Choice Transport" section:
...
{ "ok": true, "extensionConnected": true,
  ...
  "profileDetails": [
    { "profileId": "a1b2c3d4-...", "email": "user@gmail.com", "name": "Personal" },
