...
Usage:
  webmcp-browser mcp
  webmcp-browser mcp --help
  webmcp-browser gateway start
  webmcp-browser gateway health [--json]
  webmcp-browser health [--json]
  webmcp-browser doctor [--json]
  webmcp-browser bootstrap plan|apply|canary|vault-key-plan|binding-plan|tailnet-plan|tailnet-apply|profile-candidates|enroll-role|service-plan|service-apply|service-install-plan|service-install|service-load-plan|service-load|enroll-alias|enroll-binding [--json]
  webmcp-browser launch [--name <name> | --profile-id <id>] [--gateway] [--relaunch] [--dry-run] [--json]
  webmcp-browser close [--profile-id <id>] [--all] [--json]
  webmcp-browser quit [--json]
  webmcp-browser profiles list [--json]
  webmcp-browser profile-pool acquire|renew|release|list|status|reclaim|doctor [--json]
  webmcp-browser call <method> [jsonParams]
  webmcp-browser project <command> [options]
